...
function UpdateProfileInformation({
  ...
  console.log(user);
  return /* @__PURE__ */ jsx("section", { className, children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "mt-6 space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsx(
        "select",
        {
          ...
          children: roles.map((role) => /* @__PURE__ */ jsx("option", { value: role.name, children: role.name }, role.id))
        }
      ),
      errors.roles && /* @__PURE__ */ jsx("div", { className: "mt-2 text-sm text-red-600", children: errors.roles })
    ] }),
