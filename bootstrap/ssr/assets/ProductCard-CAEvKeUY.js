...
import { Flex, Button, Card, Image, Typography } from "antd";
import Meta from "antd/es/card/Meta.js";
import { ShareAltOutlined, SwapOutlined, HeartOutlined } from "@ant-design/icons";
import { router } from "@inertiajs/react";
function ProductCard({ product }) {
  return /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center ", children: /* @__PURE__ */ jsxs("div", { className: "overflow-hidden  cursor-pointer rounded-xl relative group", children: [
    /* @__PURE__ */ jsx("div", { className: "rounded-xl z-50 opacity-0 group-hover:opacity-100  transition duration-300 ease-in-out cursor-pointer absolute bottom-0 left-0 right-0 top-0 from-black/80 to-transparent bg-gradient-to-t inset-x-0 pt-30 text-white flex items-end", children: /* @__PURE__ */ jsxs(
      Flex,
      {
        style: {
          height: "100%",
