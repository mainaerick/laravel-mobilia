                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        ...
                        <div className={"flex justify-between"}>
                            ...
                            <SearchOutlined className={"space-x-8 sm:-my-px sm:ms-10 sm:flex"}/>
                            <HeartOutlined className={"space-x-8 sm:-my-px sm:ms-10 sm:flex"}/>
                            <ShoppingCartOutlined className={"space-x-8 sm:-my-px sm:ms-10 sm:flex"}/>
                        </div>
